...
@register_config("qwen3_embedding_with_projection")
class Qwen3EmbeddingConfig(EasyDeLBaseConfig):
    """Configuration container for the Qwen3-Embedding model with projection head."""

    model_type = "qwen3_embedding_with_projection"
    ...
    def __init__(
        ...
        embedding_dim=256,
        combined_base_model_type="qwen3",
        combined_base_architectures=None,
        **kwargs,
    ):
        ...
        self.combined_base_model_type = combined_base_model_type
        self.combined_base_architectures = combined_base_architectures
    ...
    def get_partition_rules(self, *args, **kwargs):
        ...
        return (
            ...
            # Embedding layer should be Replicated to avoid sharding issues
            # when vocab_size is not divisible by device count
            (r"embed_tokens/embedding", pmag.resolve(Replicated)),
